...
function plotQuiverGraph() {
    ...
    const vizs = {
        graph: new _vis_GeneralContourPlot__WEBPACK_IMPORTED_MODULE_2__["ContourPlot"](sels.quiverPlot, eventHandler, updater, { xrange: [0, 1.6], yrange: [0, 1.6] }),
...
class ContourPlot extends _util_SVGVisComponent__WEBPACK_IMPORTED_MODULE_2__["SVGVisComponent"] {
    constructor(d3parent, eventHandler, updater, options = {}) {
        ...
        this.updater = updater == null ? new _Updater2D__WEBPACK_IMPORTED_MODULE_5__["Updater2D"]() : updater;
        this.initPlot();
    }
    linspace() {
        const op = this.options;
    ...
    plotContours() {
        ...
        const contourFunc = (x, y) => {
            const loss = this.updater.loss(numjs__WEBPACK_IMPORTED_MODULE_8__["array"]([x, y]));
            return loss;
        };
        ...
        scales.color = (x) => d3__WEBPACK_IMPORTED_MODULE_0__["scaleLinear"]().domain([-1, 0.1]).range([0, 1]).interpolate(() => d3__WEBPACK_IMPORTED_MODULE_0__["interpolateBlues"])(x);
